...
<!-- SELECT t1.client_name, t1.contact, t1.meal_type, t3.name FROM client_tbl 
AS t1 
JOIN client_to_bld AS t2 ON t1.client_id=t2.id
JOIN bld AS t3 ON t2.id=t3.bidid -->
								...
								<table cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered table-striped	 display" width="100%">
									...
									<c:forEach var="row" items="${Rec.rows}">
										<tr class="odd gradeX">
											...
											<td class="center">${row.meal_type}</td>
										</tr>
									</c:forEach>
									</tbody>
									<tfoot>
